$(document).ready(function() {
        ...
        jQuery('#sample_4_wrapper .dataTables_filter input').addClass("form-control"); // modify table search input
        jQuery('#sample_4_wrapper .dataTables_length select').addClass("form-control"); // modify table per page dropdown
        ...
        jQuery('#sample_5_wrapper .dataTables_filter input').addClass("form-control"); // modify table search input
        jQuery('#sample_5_wrapper .dataTables_length select').addClass("form-control"); // modify table per page dropdown
        ...
        jQuery('#sample_6_wrapper .dataTables_filter input').addClass("form-control"); // modify table search input
        jQuery('#sample_6_wrapper .dataTables_length select').addClass("form-control"); // modify table per page dropdown
