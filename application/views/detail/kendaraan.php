          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          <li class="active"><a class="" href="<?php echo base_url(''); ?>./kendaraan">List Kendaraan</a></li>
          ...
          <section class="wrapper">
            ...
            <div class="row">
            	<div class="col-lg-12">
                  ...
                  <a class="btn btn-success" href="<?php echo base_url().'kendaraan/change_kendaraan/'.$data['id']; ?>">Update</a>
                  <a class="btn btn-success" href="<?php echo base_url().'service/add_service/'.$data['id']; ?>"><i class="icon-plus-sign"></i>&nbsp;Buat Data Service</a>    
                                </div></td>
                            </tr>
                        </table>
                      <?php endforeach; ?><table class="table table-striped table-advance table-hover border-top" id="sample_2">
        <thead>
          <tr>
            <th>No</th>
            <th>Kode Servis</th>
            ...
            <tr>
              <td><?php echo ++$no; ?></td>
              <td><?php echo $data['KodeService']; ?></td>
              <td><?php echo $data['TglService']; ?></td>
              <td><?php echo $data['BiayaService']; ?></td>
              <td><?php echo $data['IDKendaraan']; ?></td>
              <td><?php echo $data['IDJenisService']; ?></td>
              <td><div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url().'service/change_service/'.$data['id']; ?>"><i class="icon_pencil-edit"></i></a>
                <a class="btn btn-danger" href="<?php echo base_url().'service/delete_service/'.$data['id']; ?>"><i class="icon_close_alt2"></i></a>
              </div></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
