                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              echo form_open(base_url('kendaraan/update_kendaraan'), 'class="form-horizontal "'); ?>
                                  <input name="id" type="hidden" id="id" value="<?php echo $data['id']; ?>">
                                  <input name="idpem" type="hidden" id="idpem" value="<?php echo $data['IDPemilik']; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Tahun</label>
                                      <div class="col-sm-10">
                                          <input name="tahun" type="text" required class="form-control" id="tahun" value="<?php echo $data['Tahun']; ?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="tarif" type="text" required class="form-control" id="tarif" maxlength="20" value="<?php echo $data['TarifperJam']; ?>">
                                          <span class="help-block"><?php echo form_error('tarif'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Status Rental</label>
                                      <div class="col-sm-10">
                                        <select name="status" required id="status" class="form-control m-bot15">
                                          <option value="0"
                                          <?php if($data['StatusRental'] == 0){
                                              echo " selected ";
                                            } ?>>Keluar</option>
                                          <option value="1"
                                          <?php if($data['StatusRental'] == 1){
                                              echo " selected ";
                                            } ?>>Ada</option>
                                        </select>
