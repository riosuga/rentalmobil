                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              echo form_open(base_url('karyawan/update_karyawan'), 'class="form-horizontal "'); ?>
                                  <input name="id" type="hidden" id="id" value="<?php echo $data['id']; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama</label>
                                      <div class="col-sm-10">
                                          <input name="nama" type="text" required="required" class="form-control" id="nama" maxlength="50" value="<?php echo $data['NmKaryawan']; ?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="alamat" type="text" required="required" class="form-control" id="alamat" value="<?php echo $data['AlmtKaryawan']; ?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="telp" type="text" required="required" class="form-control" id="telp" maxlength="20" value="<?php echo $data['TelpKaryawan']; ?>">
