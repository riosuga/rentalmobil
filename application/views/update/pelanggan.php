                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              echo form_open(base_url('pelanggan/update_pelanggan'), 'class="form-horizontal "'); ?>
                                  <input name="id" type="hidden" id="id" value="<?php echo $data['id']; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama Pelanggan</label>
                                      <div class="col-sm-10">
                                          <input name="namapel" type="text" required="required" class="form-control" id="nama" maxlength="50" value="<?php echo $data['NamaPel']; ?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="alamatpel" type="text" required="required" class="form-control" id="alamat" value="<?php echo $data['AlamatPel']; ?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="telppel" type="text" required="required" class="form-control" id="telp" maxlength="20" value="<?php echo $data['TelpPel']; ?>">
