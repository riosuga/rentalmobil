...
<html lang="en">
  <head>
    ...
    <title>Data Type Kendaraan</title>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              echo form_open(base_url('type/update_type'), 'class="form-horizontal "'); ?>
                                  <input name="id" type="hidden" id="id" value="<?php echo $data['id']; ?>">
                                  <input name="idmerk" type="hidden" id="idmerk" value="<?php echo $data['idmerk']; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama Type</label>
                                      <div class="col-sm-10">
                                          <input name="nama" type="text" required="required" class="form-control" id="nama" maxlength="20" value="<?php echo $data['NmType']; ?>">
