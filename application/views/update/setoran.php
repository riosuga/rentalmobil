      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="active">
                      <a href="<?php echo base_url(''); ?>./pemilik" class="active">
                          <i class="icon-user"></i>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              echo form_open(base_url('setoran/update_setoran'), 'class="form-horizontal "'); ?>
                                  <input name="id" type="hidden" id="id" value="<?php echo $data['id']; ?>">
                                  <input name="idtype" type="hidden" id="idtype" value="<?php echo $data['IDPemilik']; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Tanggal Setoran</label>
                                      <div class="col-sm-10">
                                          <input name="tgl" type="date" required="required" class="form-control" id="tgl" maxlength="20" value="<?php echo $data['TglSetoran']; ?>">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                           <input name="jumlah" type="text" required="required" class="form-control" id="jumlah" maxlength="20" value="<?php echo $data['Jumlah']; ?>">
