                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              echo form_open(base_url('sopir/update_sopir'), 'class="form-horizontal "'); ?>
                                  <input name="id" type="hidden" id="id" value="<?php echo $data['id']; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama</label>
                                      <div class="col-sm-10">
                                          <input name="nama" type="text" required="required" class="form-control" id="nama" maxlength="50" value="<?php echo $data['NmSopir']; ?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="alamat" type="text" required="required" class="form-control" id="alamat" value="<?php echo $data['AlmtSopir']; ?>">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="telp" type="text" required="required" class="form-control" id="telp" maxlength="20" value="<?php echo $data['TelpSopir']; ?>">
                                          <span class="help-block"><?php echo form_error('telp'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">No SIM</label>
                                      <div class="col-sm-10">
                                          <input name="nosim" type="text" required="required" class="form-control" id="nosim" maxlength="20" value="<?php echo $data['NoSIM']; ?>">
                                          <span class="help-block"><?php echo form_error('nosim'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Tarif Per Jam</label>
                                      <div class="col-sm-10">
                                          <input name="tarif" type="text" required="required" class="form-control" id="tarif" maxlength="20" value="<?php echo $data['TarifperJam']; ?>">
                                          <span class="help-block"><?php echo form_error('tarif'); ?></span>
                                      </div>
                                  </div>
