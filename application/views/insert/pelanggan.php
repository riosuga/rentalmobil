                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Insert New Pelanggan Data
                          </header>
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('pelanggan/create_pelanggan'), 'class="form-horizontal "'); ?>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">No KTP</label>
                                      <div class="col-sm-10">
                                          <input name="noktp" type="text" autofocus="autofocus" required="required" class="form-control" id="nik" maxlength="20">
                                          <span class="help-block"><?php echo form_error('noktp'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama Pelanggan</label>
                                      <div class="col-sm-10">
                                          <input name="namapel" type="text" required="required" class="form-control" id="nama" maxlength="50">
                                          <span class="help-block"><?php echo form_error('namapel'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Alamat Pelanggan</label>
                                      <div class="col-sm-10">
                                          <input name="alamatpel" type="text" required="required" class="form-control" id="alamat">
                                          <span class="help-block"><?php echo form_error('alamatpel'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">No Telepon</label>
                                      <div class="col-sm-10">
                                          <input name="telppel" type="text" required="required" class="form-control" id="telp" maxlength="20">
                                          <span class="help-block"><?php echo form_error('telppel'); ?></span>
                                      </div>
                                  </div>
