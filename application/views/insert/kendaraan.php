                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <?php echo form_open(base_url('kendaraan/create_kendaraan'), 'class="form-horizontal "'); ?>
                                  <input name="idpemilik" type="hidden" id="idpemilik" value="<?php echo $idpemilik; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">No Plat</label>
                                      <div class="col-sm-10">
                                        <input name="plat" type="text" autofocus required class="form-control" id="plat" maxlength="20">
                                          <span class="help-block"><?php echo form_error('plat'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Tahun</label>
                                      <div class="col-sm-10">
                                          <input name="thn" type="text" required class="form-control" id="thn" maxlength="4">
                                          <span class="help-block"><?php echo form_error('thn'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Tarif/jam</label>
                                      <div class="col-sm-10">
                                        <input name="tarif" type="text" required class="form-control" id="tarif">
                                      ...
                                      <div class="col-sm-10">
                                        <select name="idtype" required id="idtype" class="form-control m-bot15">
                                          <?php foreach ($list as $lists) {
                                            echo '<option value="'.$lists['id'].'">'.$lists['NmType'].'</option>';
                                          } ?>
                                        </select>
