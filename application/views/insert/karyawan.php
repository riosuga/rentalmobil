                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('karyawan/create_karyawan'), 'class="form-horizontal "'); ?>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">NIK</label>
                                      <div class="col-sm-10">
                                          <input name="nik" type="text" autofocus="autofocus" required="required" class="form-control" id="nik" maxlength="20">
                                          <span class="help-block"><?php echo form_error('nik'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
