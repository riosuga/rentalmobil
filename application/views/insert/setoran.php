                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('setoran/create_setoran'), 'class="form-horizontal "'); ?>
                                  <input name="id" type="hidden" id="id" value="<?php echo $setoran; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nomor Setoran</label>
                                      <div class="col-sm-10">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="jumlah" type="text" autofocus="autofocus" required="required" class="form-control" id="jumlah" maxlength="5">
