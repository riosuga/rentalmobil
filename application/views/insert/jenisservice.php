                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Insert New Jenis Service
                          </header>
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('jenisservice/create_jenisservice'), 'class="form-horizontal "'); ?>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">ID Jenis Service</label>
                                      <div class="col-sm-10">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama Jenis Service</label>
                                      <div class="col-sm-10">
                                          <input name="nama" type="text" required="required" class="form-control" id="nama" maxlength="20">
