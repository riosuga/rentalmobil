      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li>
                      <a href="<?php echo base_url(''); ?>./setoran" class="">
                          <i class="icon-money"></i>
                          <span>Setoran Sewa</span>
                      </a>
                  </li>
                  <li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('service/create_service'), 'class="form-horizontal "'); ?>
                                  <input name="idkendaraan" type="hidden" id="idkendaraan" value="<?php echo $idkendaraan; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Kode Servis</label>
                                      <div class="col-sm-10">
                                          <input name="kode" type="text" autofocus="autofocus" required="required" class="form-control" id="kode" maxlength="5">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="tgl" type="date" required="required" class="form-control" id="tgl" maxlength="20">
                                          <span class="help-block"><?php echo form_error('tgl'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Biaya Service</label>
                                      <div class="col-sm-10">
                                          <input name="biaya" type="text" required="required" class="form-control" id="biaya" maxlength="20">
                                          <span class="help-block"><?php echo form_error('biaya'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Jenis Service</label>
                                      <div class="col-sm-10">
                                        <select name="idtype" required id="idtype" class="form-control m-bot15">
                                          <?php foreach ($list as $lists) {
                                            echo '<option value="'.$lists['id'].'">'.$lists['NmJenisService'].'</option>';
                                          } ?>
                                        </select>
