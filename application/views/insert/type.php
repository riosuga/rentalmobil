                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('type/create_type'), 'class="form-horizontal "'); ?>
                                  <input name="idmerk" type="hidden" id="idmerk" value="<?php echo $idmerk; ?>">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama Type</label>
                                      <div class="col-sm-10">
