                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('login/create_login'), 'class="form-horizontal "'); ?>
                                  <input name="idkary" type="hidden" id="idkary" value="<?php echo $idlog; ?>">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Username</label>
                                      <div class="col-sm-10">
                                          <input name="user" type="text" autofocus required class="form-control" id="user" maxlength="10">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="pass" type="password" required class="form-control" id="pass" maxlength="50">
