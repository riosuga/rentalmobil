                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Insert New Sopir Data
                          </header>
                          <div class="panel-body">
                          	  <?php echo form_open(base_url('sopir/create_sopir'), 'class="form-horizontal "'); ?>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">ID Sopir</label>
                                      <div class="col-sm-10">
                                          <input name=kode type="text" autofocus="autofocus" required="required" class="form-control" id="kode" maxlength="20">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="nama" type="text" required="required" class="form-control" id="nama" maxlength="50">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="alamat" type="text" required="required" class="form-control" id="alamat">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="telp" type="text" required="required" class="form-control" id="telp" maxlength="20">
                                          <span class="help-block"><?php echo form_error('telp'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nomor SIM</label>
                                      <div class="col-sm-10">
                                          <input name="nosim" type="text" required="required" class="form-control" id="nosim" maxlength="20">
                                          <span class="help-block"><?php echo form_error('telp'); ?></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name="tarif" type="text" required="required" class="form-control" id="tarif" maxlength="20">
                                          <span class="help-block"><?php echo form_error('telp'); ?></span>
                                      </div>
                                  </div>
