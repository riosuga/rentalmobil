          ...
          <section class="wrapper">
            ...
            <div class="row">
				...
				<header class="panel-heading">
					<a class="btn btn-primary" href="<?php echo base_url('transaksisewa/add_transaksi')?>"><i class="icon_plus_alt2"></i> Tambah Transaksi</a>
				</header>
                	...
                	<?php $no=0; foreach ($read as $data): ?>
						<tr>
							...
							<td><div class="btn-group">
								<a class="btn btn-info" href="<?php echo base_url().'transaksisewa/detail_transaksi/'.$data['id']; ?>"><i class="icon_pencil-edit"></i>&nbsp;Detail</a>
							</div></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
