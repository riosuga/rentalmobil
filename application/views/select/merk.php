  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <header class="panel-heading">
          <a class="btn btn-primary" href="<?php echo base_url()?>./merk/add_merk"><i class="icon_plus_alt2"></i> Tambah Data</a>
        </header>
          ...
          <tr>
            ...
            <tr>
              ...
              <td><div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url().'merk/detail_merk/'.$data['id']; ?>"><i class="icon_pencil-edit"></i></a>
                <a class="btn btn-danger" href="<?php echo base_url().'merk/delete_merk/'.$data['id']; ?>"><i class="icon_close_alt2"></i></a>
              </div></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
