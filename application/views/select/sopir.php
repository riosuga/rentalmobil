  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <header class="panel-heading">
          <a class="btn btn-primary" href="<?php echo base_url('sopir/add_sopir')?>"><i class="icon_plus_alt2"></i> Tambah Data</a>
        </header>
          ...
          <tr>
            ...
            <tr>
              ...
              <td><div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url().'sopir/change_sopir/'.$data['id']; ?>"><i class="icon_pencil-edit"></i></a>
                <a class="btn btn-danger" href="<?php echo base_url().'sopir/delete_sopir/'.$data['id']; ?>"><i class="icon_close_alt2"></i></a>
              </div></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
