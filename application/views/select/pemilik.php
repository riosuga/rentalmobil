  ...
  <section id="container" class="">
      ...
      <section id="main-content">
        ...
        <header class="panel-heading">
          <a class="btn btn-primary" href="<?php echo base_url()?>./pemilik/add_pemilik"><i class="icon_plus_alt2"></i> Tambah Data</a>
        </header>
          ...
          <tr>
            ...
            <tr>
              ...
              <td><div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url().'pemilik/detail_pemilik/'.$data['id']; ?>"><i class="icon_pencil-edit"></i></a>
                <a class="btn btn-danger" href="<?php echo base_url().'pemilik/delete_pemilik/'.$data['id']; ?>"><i class="icon_close_alt2"></i></a>
              </div></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
