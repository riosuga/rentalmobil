  ...
  <section id="container" class="">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="<?php echo base_url(''); ?>./jenisservice">Jenis Service</a></li>
                      </ul>
                  </li>
                  <li>
      ...
      <section id="main-content">
        ...
        <header class="panel-heading">
          <a class="btn btn-primary" href="<?php echo base_url()?>./jenisservice/add_jenisservice"><i class="icon_plus_alt2"></i> Tambah Data</a>
        </header>
        ...
        <thead>
          <tr>
            ...
            <th><i class="icon_cogs"></i> Action</th>
                ...
                <tbody>
                  <?php $no=0; foreach ($read as $data): ?>
            <tr>
              <td><?php echo ++$no; ?></td>
              <td><?php echo $data['IDJenisService']; ?></td>
              <td><?php echo $data['NmJenisService']; ?></td>
              <td><div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url().'jenisservice/change_jenisservice/'.$data['id']; ?>"><i class="icon_pencil-edit"></i></a>
                <a class="btn btn-danger" href="<?php echo base_url().'jenisservice/delete_jenisservice/'.$data['id']; ?>"><i class="icon_close_alt2"></i></a>
              </div></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
